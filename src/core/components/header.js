    ...
    return (
        <div {...rest}>
            ...
            <div className="flex-1">
                <div class="flex bg-gray-700 sticky top-0 inset-x-0 z-100 h-16 items-center">
                    <div class="w-full max-w-screen-xl relative mx-auto px-6">
                        <div class="flex items-center  justify-center -mx-6">
                            <div class="lg:w-1/4 xl:w-1/5 pl-6 pr-6 lg:pr-8">
                                <div class="flex items-center">
                                    <a href="/" class="block">
                                        <svg class="h-10 w-auto md:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 294 119.4">
            ...
            <div className="flex-1 text-right">
                {
                    ...
                    <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center" onClick={signOut}>
                        <span class="mr-2">Sign Out</span>
                        <svg viewBox="0 0 20 20" fill="currentColor" className="logout w-6 h-6">
